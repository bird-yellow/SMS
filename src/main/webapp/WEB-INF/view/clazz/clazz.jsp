                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <c:forEach   items="${pagers.datas}" var="data">
                                    <tr>
                                        ...
                                        <td>${data.name}</td>
                                        <td>
                                            <a href="/clazz/deleteById?id=${data.id}">
                                                <button type="button" class="btn btn-danger">删除</button>
                                            </a>
                                            <a href="/student/findBySqlByClazz?id=${data.id}">
                                                <button type="button" class="btn btn-info">所有学生</button>
                                            </a>
                                            <a href="/teacher/teacherInfo?id=${data.id}">
                                                <button type="button" class="btn btn-primary">班主任</button>
                                            </a>
                                            <a href="/clazz/updateById?id=${data.id}">
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="pagelist">
                                            <!--分页开始-->
                                            <pg:pager url="/clazz/findBySql" maxIndexPages="5" items="${pagers.total}" maxPageItems="8" export="curPage=pageNumber">
                                                <pg:last>
